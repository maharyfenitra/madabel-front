      ...
      <Card className="shadow-lg rounded-2xl border border-gray-200">
        ...
        <form onSubmit={handleSubmit}>
          <CardContent className="pt-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <Input id="password" name="password" type="password" value={formData.password} onChange={(e: ChangeEvent<HTMLInputElement>) => handleChange("password", e.target.value)} required />
              </div>
          ...
          <CardFooter className="flex justify-end space-x-3 mt-2">
            ...
            <Button className="bg-yellow-500 hover:bg-yellow-600 text-black" type="submit">Créer l'utilisateur</Button>
          </CardFooter>
        </form>
      </Card>
    </div>
